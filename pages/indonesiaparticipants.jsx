      ...
      <section className="registration-section">
        <div className="container">
          <div className="content">
            ...
            <br />
            <h4>
              HELLO ISF 2025 PARTICIPANTS, Please consider the following information before filling out the registration form :
            </h4>
            <br />
            <p>
              ...
              <div className="user-details">
                ...
                <div className="input-box">
                  <label for="INFORMATION_RESOURCES" className="form-label">
                    ISF 2025 Competition Information Resources
                  </label>
                  <select
                    type="text"
                  ...
                  >
                    ...
                    <option value="ISF Instagram">ISF Instagram</option>
                    ...
                    <option value="ISF Website">ISF Website</option>
                    {/* <option value="IYSA Email">IYSA Email</option> */}
                    <option value="ISF Email">ISF Email</option>
